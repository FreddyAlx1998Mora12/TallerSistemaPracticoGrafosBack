...
/**
 * Clase que identifica una Estacion o Lineas de Transporte Contiene una lista
 * de Rutas, Ejmpl: L2 (Estacion) : [Sauces, Motupe, Pitas, Terminal...] (Rutas)
...
public class Estacion {
	...
	public String toString() {
		return "Estacion {idEstacion=" + idEstacion + ", codigoEstacion=" + codigoEstacion + ", horaInicio="
				+ horaInicio + ", horaFin=" + horaFin + ", nroUnidades=" + nroUnidades + "}";
	}
