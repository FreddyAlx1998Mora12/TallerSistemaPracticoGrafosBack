...
/**
 * Es una clase abstracta que identifica un grafo,
 * contiene metodos como nro_vertices
 */
public abstract class Graph {
	...
	// metodo abstract que compara si son aristas o mejor dicho verificar si estan conectado un vertice a otro vertice
	...
	// Es una lista de adyacencia, sus vertices o enlaces con que otros grafos estan conectados
			...
			for (int i = 1; i < this.nro_vertice(); i++) {
				...
				if (!list_adyacencias.isEmptyLinkedList()) {
					...
					for (int j = 0; j < ady.length; j++) {
						...
						grafo += "adyacencia: "+"V"+adyacencia.getVertice_destino()+", peso de adyacencia: "+adyacencia.getPeso()+"\n";
